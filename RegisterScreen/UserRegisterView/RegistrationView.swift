...
//        VStack {
//            TitileTextField(title: "Name", input: $viewModel.name)
//            
//            TitileTextField(title: "Email", input: $viewModel.email)
//            
//            TitileTextField(title: "Adress", input: $viewModel.adress)
//            
//            TitileTextField(title: "PhoneNumber", input: $viewModel.phoneNumber)
//            
//            TitileTextField(title: "State", input: $viewModel.state)
...
//    var body: some View{
//        VStack{
//            TitileTextField(title: "Name of Children", input: $child.childrenName)
//            
