...
//    @State var userData: UsersData = UsersData(id: 6, email: "", userName: "", password: "", DOB: "", Phone: "")
...
//                    .font(.largeTitle)
//                
//                TitileTextField(title: "Enter your Name", input: $userData.userName, unValid: $nameValid)
//                
//                TitileTextField(title: "Your Age", input: $userData.DOB, keyBoardType: .numberPad, unValid: $ageValid)
//                
//                Button {
//                    
